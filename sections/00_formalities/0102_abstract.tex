...
A stock-out in a warehouse will increase the distance of the inventory to the customers located around this warehouse.
...
Limitations: cost, doest it make sense (only when customer in-stock value + contribution profit exceed transshipment cost).
